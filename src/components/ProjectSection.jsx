...
class ProjectContainer extends React.Component {
    ...
    render() {
        return (
            <Container id={this.props.id} style={(this.state.RemoveOnScroll) ? RemoveOnScroll : {}} class="ProjectContainer_EQCSS_1">
                <Waypoint
                  bottomOffset='-400px'
                  scrollableAncestor={this.WindowObject}
                  onEnter={()=> this.setState({RemoveOnScroll: false})}
              ...
              <Link to={this.props.to}>
                    <Display class="ProjectContainer_EQCSS_2">
                        <svg data viewBox="0 0 32 32">
                        ...
                        <span class="ProjectContainer_EQCSS_2A">{this.props.title}</span>
                    </Display>
                </Link>
                <Overview class="ProjectContainer_EQCSS_1A">
                    ...
                    <Row><Highlight>Role</Highlight><span>{this.props.role}</span></Row>
                </Overview>
            </Container>
        );
    }
