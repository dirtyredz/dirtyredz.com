  ...
  return(
    <div id="Footer">
      <div className="IconContainer">
        {FirstHalf_ExternalLinks && FirstHalf_ExternalLinks.map(link=><a style={{boxShadow: "none"}} target="blank" href={link.url}><link.icon className="FooterIcons" width={40}/></a>)}
      </div>
      ...
      <div className="IconContainer">
        {SecondHalf_ExternalLinks && SecondHalf_ExternalLinks.map(link=><a style={{boxShadow: "none"}} target="blank" href={link.url}><link.icon className="FooterIcons" width={40}/></a>)}
      </div>
    </div>
  )
}
