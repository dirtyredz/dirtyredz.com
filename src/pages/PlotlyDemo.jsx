        ...
        return (
              <AboutSection style={(this.state.RemoveOnScroll) ? RemoveOnScroll : {}}>
                <Content>
                    ...
                    <div>
                        <StyledP>
                          Here is a set of examples where I use <WorpPop><a href="https://plot.ly/javascript/" target="_blank">plotly.js</a></WorpPop> to create dynamic, beautiful graphs, and charts.
                          <br/>
                          <br/>
                        </StyledP>
                        <br class="clear"/>
